...
static int radxaserialOpen (char *device, int baud)
{
...
static int radxaserialFlush (int fd)
{
...
static int radxaserialClose (int fd)
{
	return close (fd) ;
}
...
static int radxaserialPutchar (int fd, unsigned char c)
{
	return write (fd, &c, 1) ;
}
...
static int radxaserialPuts (int fd, char *s)
{
...
static int radxaserialPrintf (int fd, char *message, ...)
{
	va_list argp ;
	char buffer [1024] ;
	...
	return radxaserialPuts (fd, buffer) ;
}
...
static int radxaserialDataAvail (int fd)
{
	int result ;
...
static int radxaserialGetchar (int fd)
{
	uint8_t x ;
...
void radxaInit(void) {
	...
	radxa->serialOpen=&radxaserialOpen;
	radxa->serialClose=&radxaserialClose;
	radxa->serialFlush=&radxaserialFlush;
	radxa->serialPutchar=&radxaserialPutchar;
	radxa->serialPuts=&radxaserialPuts;
