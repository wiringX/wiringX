...
static struct layout_t {
	...
	{"GPIO3_B1", 3, {CRU_CLKGATE_CON31, 4}, {GRF_GPIO3B_IOMUX,  0}, {GPIO_SWPORTA_DDR, 9}, {GPIO_SWPORTA_DR, 9}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO3_B2", 3, {CRU_CLKGATE_CON31, 4}, {GRF_GPIO3B_IOMUX,  0}, {GPIO_SWPORTA_DDR, 10}, {GPIO_SWPORTA_DR, 10}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO3_B3", 3, {CRU_CLKGATE_CON31, 4}, {GRF_GPIO3B_IOMUX,  0}, {GPIO_SWPORTA_DDR, 11}, {GPIO_SWPORTA_DR, 11}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO3_B4", 3, {CRU_CLKGATE_CON31, 4}, {GRF_GPIO3B_IOMUX,  0}, {GPIO_SWPORTA_DDR, 12}, {GPIO_SWPORTA_DR, 12}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO3_B5", 3, {CRU_CLKGATE_CON31, 4}, {GRF_GPIO3B_IOMUX,  0}, {GPIO_SWPORTA_DDR, 13}, {GPIO_SWPORTA_DR, 13}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO3_B6", 3, {CRU_CLKGATE_CON31, 4}, {GRF_GPIO3B_IOMUX,  0}, {GPIO_SWPORTA_DDR, 14}, {GPIO_SWPORTA_DR, 14}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO3_B7", 3, {CRU_CLKGATE_CON31, 4}, {GRF_GPIO3B_IOMUX,  0}, {GPIO_SWPORTA_DDR, 15}, {GPIO_SWPORTA_DR, 15}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
